	...
	protected GrammarNode createGrammar(){
		...
		while(iter.hasNext()){
            ...
            while (tokensIter.hasNext()) {
                ...
                //Add silence after the word to denote the end of the word.
                GrammarNode silenceNodeBegin = createGrammarNode(Dictionary.SILENCE_SPELLING);
                GrammarNode silenceNodeEnd = createGrammarNode(Dictionary.SILENCE_SPELLING);
                float value;
              ...
              lastWordGrammarNode.add(silenceNodeBegin, logMath.getLogOne());
      		    lastWordGrammarNode.add(currNode, value);
              lastWordGrammarNode.add(silenceNodeEnd, logMath.getLogOne());
              //lastWordGrammarNode = silenceNodeEnd;
